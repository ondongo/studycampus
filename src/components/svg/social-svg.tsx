...
export function WhatsappSvg() {
  return (
    ...
    >
      <path
        d="M20.52 3.48C18.43 1.39 15.42 0.5 12.34 1.02 6.85 1.9 2.75 7.06 3.13 12.59c.16 2.69 1.57 5.18 3.84 6.72l-1.42 4.86 4.99-1.33c1.54.79 3.27 1.07 4.97.8 5.49-1.01 8.95-7.2 6.34-12.82Zm-2.87 10.02c-.2.58-1.14 1.11-1.55 1.18-.4.07-.87.1-1.5-.19a11.94 11.94 0 0 1-5.57-5.4c-.32-.54-.07-.88.24-1.15.25-.21.58-.54.87-.8.3-.27.4-.46.6-.46.22 0 .45 0 .68.33.23.33.77 1.13.83 1.21.07.08.12.17.04.3-.07.13-.1.22-.2.34-.1.12-.22.27-.32.4-.1.14-.21.3-.1.54.12.24.53.86 1.15 1.41 1.58 1.34 2.31 1.77 2.66 2.04.35.27.56.23.77.14.21-.1.66-.24.75-.3.1-.06.33-.12.4-.18.08-.07.08-.2.05-.3Z"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
